...
public class ActivityListadoEventos extends ActivityBasic {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rcEventos = (RecyclerView) findViewById(R.id.RecyclerEventosCliente);
        rcEventos.setHasFixedSize(true);
        rcEventos.setLayoutManager(new LinearLayoutManager(this));

        StringRequest stringRequest = new StringRequest(Request.Method.GET, ActivityAutentificacion.URLPruebas + "Componentes/RecyclerEventos.php", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    ...
                    AdaptadorEventosProximos adapterEventos = new AdaptadorEventosProximos(ActivityListadoEventos.this, EventosLista);
