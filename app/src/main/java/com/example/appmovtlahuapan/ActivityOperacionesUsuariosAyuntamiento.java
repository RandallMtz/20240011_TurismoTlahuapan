...
public class ActivityOperacionesUsuariosAyuntamiento extends ActivityBasic {

    private AlertDialog.Builder builder;
    private AsyncHttpClient cliente;
    private Button btBuscarUsuario, btEliminarUsuario, btInsertarUsuario, btLimpiarCampos, btModificarUsuario;
    private EditText edApellidoMaterno, edApellidoPaterno, edContraseña, edCorreo, edNombre,  edTelefono, edUsuario;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_operaciones_usuarios_ayuntamiento);

        cliente = new AsyncHttpClient();

        builder = new AlertDialog.Builder(this);

        btBuscarUsuario = findViewById(R.id.ButtonUsuarioBuscarOp);
        btEliminarUsuario = findViewById(R.id.ButtonEliminarUsuarioOp);
        btInsertarUsuario = findViewById(R.id.ButtonInsertarUsuarioOp);
        btLimpiarCampos = findViewById(R.id.ButtonLimpiarCamposUsuarioOp);
        btModificarUsuario = findViewById(R.id.ButtonModificarUsuarioOp);

        edApellidoMaterno = findViewById(R.id.EditTApellidoMatUsuarioOp);
        edApellidoPaterno = findViewById(R.id.EditTApellidoPatUsuarioOp);
    ...
    private void MetodoPoblarUsuarios(){
        String url = ActivityAutentificacion.URLPruebas + "Componentes/SpinnerUsuariosAyuntamiento.php";
    ...
    private void MetodoPoblarNivelesAdministracion(){
        String url = ActivityAutentificacion.URLPruebas + "Componentes/SpinnerNivelesUsuarioAyuntamiento.php";
        cliente.post(url, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                if (statusCode == 200){
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        if (jsonObject.getString("IdNivelAdministracion").equals("2")){
